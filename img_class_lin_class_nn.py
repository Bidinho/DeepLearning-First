...
class Perceptron(LinearModel):
    def update_weight(self, x_i, y_i, **kwargs):
        ...
        if y_hat != y_i:
            # Perceptron update.
            # We assume the learning rate is 1
            self.W[y_i, :] += x_i * eta
            self.W[y_hat, :] -= x_i * eta
...
class MLP(object):
    # This MLP skeleton code allows the MLP to be used in place of the
    ...
    def predict(self, X):
        ...
        for i in range(len(X)):
          ...
          predicted_labels.append(np.argmax(z2))
    ...
    def train_epoch(self, X, y, learning_rate=0.001):
        for x_i, y_i in zip(X, y):
            ...
            #apply softmax to z2
            z2 -= z2.max()      #this is here to avoid overflow
